...
?>
  ...
  <body>
    ...
    ///submit button was clicked.
        $obamaQuantity=$_SESSION['items']['obamaQuantity'];
    ...
    echo "<BR>";
        ...
        $gladwellQuantity=$_SESSION['items']['gladwellQuantity']; ///most of the names/keys are just the authors' last name + a particular attribute.
    ...
    echo "<BR>";
        ...
        $carnegieQuantity=$_SESSION['items']['carnegieQuantity'];
    ...
    echo "<BR>";
        $mansonQuantity=$_SESSION['items']['mansonQuantity'];
    ...
    ///submit button was clicked.
        ...
        $hillQuantity=$_SESSION['items']['hillQuantity'];
