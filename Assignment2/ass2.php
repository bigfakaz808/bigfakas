...
<html>
    ...
    <body>
        ...
        $obama = array (
                ...
                "Price"=>"$32.50",
                "Quantity"=>"<form action='login2.php' method='POST'>
                <input type='text' name='obamaQuantity' value='0'>"
        ...
        $gladwell = array (
                ...
                "Price"=>"$16.99",
                "Quantity"=>"<form action='login2.php' method='POST'>
                <input type='text' name='gladwellQuantity' value='0'>"
        );
        $carnegie = array (
            "Book"=>"<img src='carnegie.jpg' width=170px height=250px> <br> How to Win Friends & Influence People",///reduced the width/height to fit the table more
                ...
                "Price"=>"$22.95",
                "Quantity"=>"<form action='login2.php' method='POST'>
                <input type='text' name='carnegieQuantity' value='0'>"
        );
        $manson = array (
            "Book"=>"<img src='manson.jpg' width=170px height=250px> <br> The Subtle Art of Not Giving a Fuck",
                ...
                "Price"=>"$24.99",
                "Quantity"=>"<form action='login2.php' method='POST'>
                <input type='text' name='mansonQuantity' value='0'>" ///in input a default value so that there's something in the box
        );
        $hill = array (
                ...
                "Price"=>"$18.70",
                "Quantity"=>"<form action='login2.php' method='POST'>
                <input type='text' name='hillQuantity' value='0'>"
        );
